...
//	salvarColeta.sync();
	...
	if (record == null) {
	    ...
	    var store2 = Ext.create('Touch2Demo.store.dataSincronizacaoPHP');
	    var form = this.getColetasForm();
	    var camposForm = Ext.create('Touch2Demo.model.Coleta', form.getValues());
	    var data = record.data.dataSincronizacao;
	    var modelData1 = Ext.create('Touch2Demo.model.dataSincronizacaoM', {
		dataSincronizacao: camposForm.data.data_entrega
	    });
	    store2.add(modelData1);
